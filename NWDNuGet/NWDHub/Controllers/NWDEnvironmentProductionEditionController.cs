...
public class NWDEnvironmentProductionEditionController : NWDModelEditionAsyncController<NWDProjectPublishDataTrack>
{
    private const NWDEnvironmentKind _ENVIRONMENT_KIND = NWDEnvironmentKind.Production;
