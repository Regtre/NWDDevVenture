...
{
    public class NWDAccountServiceDao_MariaDbByReflexion : NWDBackMariaDbByReflexion, INWDAccountServiceDao, INWDDao
    {
        public NWDAccountServiceDao_MariaDbByReflexion(NWDDatabaseCredentials sDatabaseCredentials) : base(
