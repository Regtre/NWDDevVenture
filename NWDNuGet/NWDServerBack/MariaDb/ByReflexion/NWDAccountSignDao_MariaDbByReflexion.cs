...
{
    public class NWDAccountSignDao_MariaDbByReflexion : NWDBackMariaDbByReflexion, INWDAccountSignDao, INWDDao
    {
        public NWDAccountSignDao_MariaDbByReflexion(NWDDatabaseCredentials sDatabaseCredentials) : base(
