...
{
    public class NWDProjectCredentialsDaoMariaDbByReflexion : NWDBackMariaDbByReflexion, INWDProjectCredentialsDao,
        INWDDao
    {
        public NWDProjectCredentialsDaoMariaDbByReflexion(NWDDatabaseCredentials sDatabaseCredentials) : base(
