...
{
    public class NWDAccountInvoiceDao_MariaDbSpecific : NWDBackMariaDbSpecific, INWDAccountInvoiceDao
    {
        private NWDBackMariaDbByReflexion _ToRemoveDao;

        public NWDAccountInvoiceDao_MariaDbSpecific(NWDDatabaseCredentials sDatabaseCredentials) : base(sDatabaseCredentials)
        {
