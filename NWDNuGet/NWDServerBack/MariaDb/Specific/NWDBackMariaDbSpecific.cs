...
{
    public class NWDBackMariaDbSpecific
    {
        private readonly NWDDatabaseConnector _DBConnector;
        private readonly ushort _Range;
        private readonly string _Infos;

        protected NWDBackMariaDbSpecific(NWDDatabaseCredentials sDatabaseCredentials)
        {
        ...
        private string TableName(Type sType)
        {
            return _DBConnector.GetTableNamePrefix() + "_Specific_" + sType.Name;
        }
