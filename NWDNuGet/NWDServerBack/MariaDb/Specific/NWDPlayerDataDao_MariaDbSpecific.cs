...
{
    public class NWDPlayerDataDao_MariaDbSpecific : NWDBackMariaDbSpecific, INWDPlayerDataDao
    {
        private NWDBackMariaDbByReflexion _ToRemoveDao;

        public NWDPlayerDataDao_MariaDbSpecific(NWDDatabaseCredentials sDatabaseCredentials) : base(sDatabaseCredentials)
        {
