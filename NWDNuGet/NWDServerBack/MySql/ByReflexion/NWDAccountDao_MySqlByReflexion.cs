...
{
    public class NWDAccountDao_MySqlByReflexion : NWDBackMySqlByReflexion, INWDAccountDao, INWDDao
    {
        public NWDAccountDao_MySqlByReflexion(NWDDatabaseCredentials sDatabaseCredentials) : base(
