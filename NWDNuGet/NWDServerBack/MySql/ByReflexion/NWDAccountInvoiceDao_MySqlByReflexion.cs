...
{
    public class NWDAccountInvoiceDao_MySqlByReflexion : NWDBackMySqlByReflexion, INWDAccountInvoiceDao, INWDDao
    {
        public NWDAccountInvoiceDao_MySqlByReflexion(NWDDatabaseCredentials sDatabaseCredentials) : base(
