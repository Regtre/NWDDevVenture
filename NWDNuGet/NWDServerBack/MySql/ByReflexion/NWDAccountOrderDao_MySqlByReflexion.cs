...
{
    public class NWDAccountOrderDao_MySqlByReflexion : NWDBackMySqlByReflexion, INWDAccountOrderDao, INWDDao
    {
        public NWDAccountOrderDao_MySqlByReflexion(NWDDatabaseCredentials sDatabaseCredentials) : base(
