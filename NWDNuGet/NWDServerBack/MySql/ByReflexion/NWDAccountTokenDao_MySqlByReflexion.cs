...
{
    public class NWDAccountTokenDao_MySqlByReflexion : NWDBackMySqlByReflexion, INWDAccountTokenDao, INWDDao
    {
        public NWDAccountTokenDao_MySqlByReflexion(NWDDatabaseCredentials sDatabaseCredentials) : base(
