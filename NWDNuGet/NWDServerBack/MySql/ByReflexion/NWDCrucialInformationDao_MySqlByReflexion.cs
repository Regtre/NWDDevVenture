...
{
    public class NWDCrucialInformationDao_MySqlByReflexion : NWDBackMySqlByReflexion, INWDCrucialInformationDao, INWDDao
    {
        public NWDCrucialInformationDao_MySqlByReflexion(NWDDatabaseCredentials sDatabaseCredentials) : base(
