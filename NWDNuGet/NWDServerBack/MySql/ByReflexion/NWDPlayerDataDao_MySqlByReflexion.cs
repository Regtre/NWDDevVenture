...
{
    public class NWDPlayerDataDao_MySqlByReflexion : NWDBackMySqlByReflexion, INWDPlayerDataDao, INWDDao
    {
        public NWDPlayerDataDao_MySqlByReflexion(NWDDatabaseCredentials sDatabaseCredentials) : base(
