...
{
    public class NWDProjectServiceKeyDao_MySqlByReflexion : NWDBackMySqlByReflexion, INWDProjectServiceKeyDao, INWDDao
    {
        public NWDProjectServiceKeyDao_MySqlByReflexion(NWDDatabaseCredentials sDatabaseCredentials) : base(
