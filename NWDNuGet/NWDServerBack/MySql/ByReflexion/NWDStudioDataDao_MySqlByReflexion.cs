...
{
    public class NWDStudioDataDao_MySqlByReflexion : NWDBackMySqlByReflexion, INWDStudioDataDao, INWDDao
    {
        public NWDStudioDataDao_MySqlByReflexion(NWDDatabaseCredentials sDatabaseCredentials) : base(
