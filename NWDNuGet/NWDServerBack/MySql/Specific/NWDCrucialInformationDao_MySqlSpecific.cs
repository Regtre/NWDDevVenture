...
{
    public class NWDCrucialInformationDao_MySqlSpecific : NWDBackMySqlSpecific, INWDCrucialInformationDao
    {
        private NWDBackMySqlByReflexion _ToRemoveDao;

        public NWDCrucialInformationDao_MySqlSpecific(NWDDatabaseCredentials sDatabaseCredentials) : base(sDatabaseCredentials)
        {
