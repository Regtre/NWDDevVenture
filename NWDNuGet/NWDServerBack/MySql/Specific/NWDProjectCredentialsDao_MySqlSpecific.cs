...
{
    public class NWDProjectCredentialsDaoMySqlSpecific : NWDBackMySqlSpecific, INWDProjectCredentialsDao
    {
        private NWDBackMySqlByReflexion _ToRemoveDao;

        public NWDProjectCredentialsDaoMySqlSpecific(NWDDatabaseCredentials sDatabaseCredentials) : base(
