...
{
    public class NWDStudioDataDao_MySqlSpecific : NWDBackMySqlSpecific, INWDStudioDataDao
    {
        private NWDBackMySqlByReflexion _ToRemoveDao;

        public NWDStudioDataDao_MySqlSpecific(NWDDatabaseCredentials sDatabaseCredentials) : base(sDatabaseCredentials)
        {
        ...
        {
            return _ToRemoveDao.InsertOrUpdate(sEnvironment,sProjectId, sModel, true, false, new Dictionary<string, string> ()
            {
