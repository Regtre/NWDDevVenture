...
{
    public class NWDServerHumanInterfaceConfigureOptions : IPostConfigureOptions<StaticFileOptions>
    { 
        const string K_BasePath = "wwwroot";
        private IWebHostEnvironment Environment { get; }
        public NWDServerHumanInterfaceConfigureOptions(IWebHostEnvironment sEnvironment)
        {
