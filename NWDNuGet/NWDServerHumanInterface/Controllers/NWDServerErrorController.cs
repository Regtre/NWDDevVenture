...
{
    public class NWDServerErrorController : Controller
    {
        ...
        static NWDServerErrorController()
        {
        ...
        {
            NWDLogger.Information(nameof(NWDServerErrorController)+"."+nameof(Internal)+"();");
            AddViewDataObject(sError);
            return View("Error.cshtml");
        }
        [HttpGet]
        [Route("/ExceptionServer")]
        public IActionResult Exception()
        {
            NWDLogger.Information(nameof(NWDServerErrorController)+"."+nameof(Exception)+"();");
        ...
        [HttpGet]
        [Route("/ErrorServer/{sError}")]
        public IActionResult Error(int sError)
        {
            NWDLogger.Information(nameof(NWDServerErrorController)+"."+nameof(Error)+"("+sError+");");
            NWDWebError tError = new NWDWebError();
            tError.Error = sError;
        ...
        {
            NWDLogger.Information(nameof(NWDServerErrorController)+"."+nameof(ErrorProxy)+"();");
