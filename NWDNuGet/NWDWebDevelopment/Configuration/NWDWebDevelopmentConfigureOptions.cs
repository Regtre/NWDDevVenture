...
{
    public class NWDWebDevelopmentConfigureOptions : IPostConfigureOptions<StaticFileOptions>
    { 
        const string K_BasePath = "wwwroot";
        private IWebHostEnvironment Environment { get; }
        public NWDWebDevelopmentConfigureOptions(IWebHostEnvironment sEnvironment)
        {
