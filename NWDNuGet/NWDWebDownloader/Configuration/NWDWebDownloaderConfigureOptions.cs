...
{
    public class NWDWebDownloaderConfigureOptions : IPostConfigureOptions<StaticFileOptions>
    { 
        const string K_BasePath = "wwwroot";
        private IWebHostEnvironment Environment { get; }
        public NWDWebDownloaderConfigureOptions(IWebHostEnvironment sEnvironment)
        {
