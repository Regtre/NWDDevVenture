...
{
    public class NWDWebGitLabReportConfigureOptions : IPostConfigureOptions<StaticFileOptions>
    { 
        const string K_BasePath = "wwwroot";
        private IWebHostEnvironment Environment { get; }
        public NWDWebGitLabReportConfigureOptions(IWebHostEnvironment sEnvironment)
        {
