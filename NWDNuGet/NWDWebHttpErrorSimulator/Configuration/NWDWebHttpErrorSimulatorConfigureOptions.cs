...
{
    public class NWDWebHttpErrorSimulatorConfigureOptions : IPostConfigureOptions<StaticFileOptions>
    { 
        const string K_BasePath = "wwwroot";
        private IWebHostEnvironment Environment { get; }
        public NWDWebHttpErrorSimulatorConfigureOptions(IWebHostEnvironment sEnvironment)
        {
