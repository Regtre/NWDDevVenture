...
{
    public class NWDWebPlayerDemoConfigureOptions : IPostConfigureOptions<StaticFileOptions>
    { 
        const string K_BasePath = "wwwroot";
        private IWebHostEnvironment Environment { get; }
        public NWDWebPlayerDemoConfigureOptions(IWebHostEnvironment sEnvironment)
        {
