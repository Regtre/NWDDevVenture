...
{
    public class NWDWebStandardConfigureOptions : IPostConfigureOptions<StaticFileOptions>
    { 
        const string K_BasePath = "wwwroot";
        private IWebHostEnvironment Environment { get; }
        public NWDWebStandardConfigureOptions(IWebHostEnvironment sEnvironment)
        {
