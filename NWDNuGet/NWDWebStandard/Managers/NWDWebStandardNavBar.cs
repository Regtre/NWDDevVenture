...
{
    public class NWDWebStandardNavBar : INWDNavBar
    {
        ...
        public NWDNavBarCategory[]? AddNavBarDebug(HttpContext sHttpContext)
        {
            NWDNavBarCategory tReturn = new NWDNavBarCategory()
            {
                ...
                IconStyle = "fas fa-cube", Elements = new List<NWDNavBarElement>()
                {
                    new NWDNavBarElement()
                                     {
                                         Name = "Go to hub", ActionName = nameof(NWDRedirectionController.GoToWebsite), ControllerName = NWDRedirectionController.ASP_Controller(), UrlParameter = "sUrl="+NWDWebRuntimeConfiguration.KConfig.GetHubDnsHttps(),
                                     },
                    new NWDNavBarElement()
                    {
