...
clear
echo "Clean"
RENAME_OLD="NWDWebStudioDemo"
RENAME_NEW="NWDWebDevelopment"
OLD_SLN_ID="6D6C6F72-9F90-4BD7-B07F-9AE77D3A9B5A"
NEW_SLN_ID=$(uuidgen)
OLD_PROJECT_ID="FAE04EC0-301F-11D3-BF4B-00C04F79EFBC"
NEW_PROJECT_ID=$(uuidgen)
OLD_CONFIGURATION_ID="3EBFFFB1-5377-4215-A97D-581CA9FE1E5D"
NEW_CONFIGURATION_ID=$(uuidgen)
OLD_CONFIGURATION_TEST_ID="28F30EE0-DC9B-4C80-ADD4-1A81DE22A21C"
