...
{
    public class NWDWebUploaderConfigureOptions : IPostConfigureOptions<StaticFileOptions>
    { 
        const string K_BasePath = "wwwroot";
        private IWebHostEnvironment Environment { get; }
        public NWDWebUploaderConfigureOptions(IWebHostEnvironment sEnvironment)
        {
