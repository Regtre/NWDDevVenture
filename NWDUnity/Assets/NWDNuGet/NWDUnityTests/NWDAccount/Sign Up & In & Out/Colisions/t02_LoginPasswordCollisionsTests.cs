...
{
    public class t02_LoginPasswordCollisionsTests
    {
        /// <summary>
        ...
        public class SignInCollisionTests
        {
            ...
            public void OneTimeSetUp()
            {
                ...
                AccountCreation = NWDUnityEngine.Instance.AccountManager.LoginPasswordSignUp(Login, Password);
            }
            ...
            public IEnumerator t04_LoginMailPassword()
            {
                ...
                NWDAsyncOperation tOperation = NWDUnityEngine.Instance.AccountManager.LoginMailPasswordSignIn(Login, Login, Password);
                yield return tOperation;
                Assert.AreEqual(NWDAsyncOperationState.Warning, tOperation.State);
            }
        ...
        public class SignUpCollisionTests
        {
            ...
            public IEnumerator t04_LoginMailPassword()
            {
                ...
                NWDAsyncOperation tOperation = NWDUnityEngine.Instance.AccountManager.LoginMailPasswordSignUp(Login, Login, Password);
                yield return tOperation;
                Assert.AreEqual(NWDAsyncOperationState.Failure, tOperation.State);
            }
