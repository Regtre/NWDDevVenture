...
{
    public class t05_FacebookProcessTests
    {
        /// <summary>
        ...
        [UnityTest]
        public IEnumerator t1_SignUpWithFacebook()
        {
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.FacebookSignIn(tSocialSignature);
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
        ...
        [UnityTest]
        public IEnumerator t2_CannotSignUpWithSameFacebook()
        {
            string tSocialSignature = NWDToolbox.RandomStringUnix(kLength);
        ...
        [UnityTest]
        public IEnumerator t3_SignUpWhenConnectedWithFacebook()
        {
        ...
        public IEnumerator t4_CanSignUpWithDifferentCase()
        {
            ...
            NWDAsyncOperation tOperation = NWDUnityEngine.Instance.AccountManager.FacebookSignUp(tSocialSignature.ToUpper());
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.FacebookSignUp(tSocialSignature.ToLower());
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
        ...
        public IEnumerator t5_CannotSignInWithDifferentCase()
        {
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.FacebookSignIn(tSocialSignature.ToLower());
            yield return tOperation;
