...
{
    public class t06_DiscordProcessTests
    {
        /// <summary>
        ...
        [UnityTest]
        public IEnumerator t1_SignUpWithDiscord()
        {
            string tSocialSignature = NWDToolbox.RandomStringUnix(kLength);

            NWDAsyncOperation tOperation = NWDUnityEngine.Instance.AccountManager.DiscordSignUp(tSocialSignature);
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.DiscordSignIn(tSocialSignature);
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
        ...
        [UnityTest]
        public IEnumerator t2_CannotSignUpWithSameDiscord()
        {
            string tSocialSignature = NWDToolbox.RandomStringUnix(kLength);
        ...
        [UnityTest]
        public IEnumerator t3_SignUpWhenConnectedWithDiscord()
        {
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.DiscordSignUp(tSocialSignature2);
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
        ...
        public IEnumerator t4_CanSignUpWithDifferentCase()
        {
            ...
            NWDAsyncOperation tOperation = NWDUnityEngine.Instance.AccountManager.DiscordSignUp(tSocialSignature.ToUpper());
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.DiscordSignUp(tSocialSignature.ToLower());
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
        ...
        public IEnumerator t5_CannotSignInWithDifferentCase()
        {
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.DiscordSignIn(tSocialSignature.ToLower());
            yield return tOperation;
