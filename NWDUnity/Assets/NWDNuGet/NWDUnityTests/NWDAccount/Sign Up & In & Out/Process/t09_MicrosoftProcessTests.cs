...
{
    public class t09_MicrosoftProcessTests
    {
        /// <summary>
        ...
        /// </summary>
        private const int kLength = 95;

        [UnityTest]
        public IEnumerator t1_SignUpWithMicrosoft()
        {
            string tSocialSignature = NWDToolbox.RandomStringUnix(kLength);

            NWDAsyncOperation tOperation = NWDUnityEngine.Instance.AccountManager.MicrosoftSignUp(tSocialSignature);
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.MicrosoftSignIn(tSocialSignature);
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
        ...
        [UnityTest]
        public IEnumerator t2_CannotSignUpWithSameMicrosoft()
        {
            string tSocialSignature = NWDToolbox.RandomStringUnix(kLength);
        ...
        [UnityTest]
        public IEnumerator t3_SignUpWhenConnectedWithMicrosoft()
        {
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.MicrosoftSignUp(tSocialSignature2);
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
        ...
        public IEnumerator t4_CanSignUpWithDifferentCase()
        {
            ...
            NWDAsyncOperation tOperation = NWDUnityEngine.Instance.AccountManager.MicrosoftSignUp(tSocialSignature.ToUpper());
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.MicrosoftSignUp(tSocialSignature.ToLower());
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
        ...
        public IEnumerator t5_CannotSignInWithDifferentCase()
        {
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.MicrosoftSignIn(tSocialSignature.ToLower());
            yield return tOperation;
