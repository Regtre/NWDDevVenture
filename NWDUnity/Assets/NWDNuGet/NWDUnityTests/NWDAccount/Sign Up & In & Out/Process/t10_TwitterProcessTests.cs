...
{
    public class t10_TwitterProcessTests
    {
        /// <summary>
        ...
        /// </summary>
        private const int kLength = 100;

        [UnityTest]
        public IEnumerator t1_SignUpWithTwitter()
        {
            string tSocialSignature = NWDToolbox.RandomStringUnix(kLength);

            NWDAsyncOperation tOperation = NWDUnityEngine.Instance.AccountManager.TwitterSignUp(tSocialSignature);
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.TwitterSignIn(tSocialSignature);
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
        ...
        [UnityTest]
        public IEnumerator t2_CannotSignUpWithSameTwitter()
        {
            string tSocialSignature = NWDToolbox.RandomStringUnix(kLength);
        ...
        [UnityTest]
        public IEnumerator t3_SignUpWhenConnectedWithTwitter()
        {
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.TwitterSignUp(tSocialSignature2);
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
        ...
        public IEnumerator t4_CanSignUpWithDifferentCase()
        {
            ...
            NWDAsyncOperation tOperation = NWDUnityEngine.Instance.AccountManager.TwitterSignUp(tSocialSignature.ToLower());
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.TwitterSignUp(tSocialSignature.ToUpper());
            yield return tOperation;
            Assert.AreEqual(NWDAsyncOperationState.Success, tOperation.State);
        ...
        public IEnumerator t5_CannotSignInWithDifferentCase()
        {
            ...
            tOperation = NWDUnityEngine.Instance.AccountManager.TwitterSignIn(tSocialSignature.ToUpper());
            yield return tOperation;
